...
- summary (互動內容的摘要字串，整理成流暢的中文句子，重點記錄聊了什麼、對方的反應與興趣)

重要規則：
- 仔細辨別使用者的意圖，即使語句不完整也要盡量擷取有意義的資訊
- 如果提到產品名稱（識霸、水素水、明利多、喚活、普利活、AND、晨星、柔緹），要準確記錄
- 摘要要精簡但完整，保留關鍵細節
...
- contactMethod (聯絡方式字串，包含 LINE ID、電話等，若無則留空字串)
- products (感興趣產品的字串陣列，可選值：識霸、水素水、明利多、喚活、普利活、AND、晨星、柔緹，若無則空陣列)
- heat (熱度判斷："cold"、"warm"、"hot"、"loyal"，根據語氣與描述判斷，預設 "warm")
- notes (其他備註字串，將無法歸類的資訊放在這裡)

重要規則：
- 仔細辨別使用者的意圖，即使語句不完整也要盡量擷取有意義的資訊
- 姓名辨識要考慮中文姓名的特性（通常 2-3 個字）
- 如果使用者提到的地區是簡稱（如「北」代表台北），要自動展開為完整名稱
- 聯絡方式要完整保留，包含 LINE ID、手機號碼等
