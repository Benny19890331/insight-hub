...
export const themes: AppTheme[] = [
  ...
  },
  {
    ...
    titleColor: "#fef08a",
    titleGlow: "rgba(254,240,138,0.45)",
    ...
    selectedGlow: "shadow-[0_0_12px_-3px_rgba(254,240,138,0.35)]",
    accent: "text-blue-900",
    accentBg: "bg-yellow-200/30",
    accentBorder: "border-yellow-300/60",
    accentHover: "hover:bg-yellow-200/45",
    mutedText: "text-blue-900/85",
    btnPrimary: { color: "hsl(50 95% 30%)", border: "hsl(50 95% 35% / 0.55)", bg: "hsl(50 95% 70% / 0.35)", hoverBg: "hsl(50 95% 70% / 0.5)", shadow: "hsl(50 95% 55% / 0.35)" },
    btnSecondary: { color: "hsl(50 90% 30%)", border: "hsl(50 90% 35% / 0.45)", bg: "hsl(50 90% 65% / 0.25)", hoverBg: "hsl(50 90% 65% / 0.4)", shadow: "hsl(50 90% 45% / 0.25)" },
    btnOutline: "border-yellow-300/70 text-blue-950 hover:bg-yellow-100/80",
    inputBorder: "border-purple-300/60",
    inputBg: "bg-white/70",
    inputFocus: "focus:ring-yellow-300/55",
    badgeBg: "bg-yellow-100/70",
    authCard: "border-purple-300/35 bg-white/75",
    authCardText: "text-blue-950",
    authLabel: "text-blue-900/85",
    authInput: "border-purple-300/70 bg-white/70 text-blue-950 placeholder:text-blue-700/60 focus:ring-yellow-300/60",
    authLink: "text-yellow-700 hover:text-yellow-800",
    authSubtext: "text-blue-900/75",
    authOverlay: "from-purple-500/20 via-transparent to-indigo-400/10",
    switcherActive: "bg-yellow-200/45 ring-yellow-300/60",
  },
  {
    name: "⚡ 青年勇猛", emoji: "⚡",
  ...
  {
    name: "⬛ 暗夜極簡", emoji: "⬛",
    headerBg: "bg-neutral-950/80 backdrop-blur-xl",
    headerBorder: "border-neutral-800/30",
    titleColor: "#e5e5e5",
    titleGlow: "rgba(229,229,229,0.15)",
    textColor: "text-neutral-200",
    sidebarBg: "bg-neutral-950/80 backdrop-blur-xl",
    mainBg: "bg-neutral-950/70 backdrop-blur-lg",
    cardBg: "bg-neutral-900/60 backdrop-blur-md",
    cardBorder: "border-neutral-800/20",
    cardHover: "hover:bg-neutral-800/80",
    selectedCard: "bg-neutral-800/50",
    selectedBorder: "border-neutral-600/40",
    selectedGlow: "shadow-[0_0_12px_-3px_rgba(255,255,255,0.08)]",
    accent: "text-neutral-300",
    accentBg: "bg-neutral-700/15",
    accentBorder: "border-neutral-600/25",
    accentHover: "hover:bg-neutral-700/25",
    mutedText: "text-neutral-400/70",
    btnPrimary: { color: "hsl(0 0% 85%)", border: "hsl(0 0% 55% / 0.5)", bg: "hsl(0 0% 55% / 0.1)", hoverBg: "hsl(0 0% 55% / 0.2)", shadow: "hsl(0 0% 55% / 0.25)" },
    btnSecondary: { color: "hsl(0 0% 70%)", border: "hsl(0 0% 45% / 0.4)", bg: "hsl(0 0% 45% / 0.08)", hoverBg: "hsl(0 0% 45% / 0.18)", shadow: "hsl(0 0% 45% / 0.2)" },
    btnOutline: "border-neutral-700/50 text-neutral-300 hover:bg-neutral-800/50",
    inputBorder: "border-neutral-700/30",
    inputBg: "bg-neutral-900/50",
    inputFocus: "focus:ring-neutral-500/40",
    badgeBg: "bg-neutral-800/40",
    authCard: "border-neutral-700/30 bg-neutral-950/75",
    authCardText: "text-neutral-100",
    authLabel: "text-neutral-400/70",
    authInput: "border-neutral-700/40 bg-neutral-900/60 text-neutral-100 placeholder:text-neutral-500/50 focus:ring-neutral-500/50",
    authLink: "text-neutral-400 hover:text-neutral-300",
    authSubtext: "text-neutral-400/60",
    authOverlay: "from-neutral-800/20 via-transparent to-neutral-900/10",
    switcherActive: "bg-neutral-600/30 ring-neutral-500/50",
  },
  {
    name: "⬜ 純淨明亮", emoji: "⬜",
    ...
    titleColor: "#b8860b",
    titleGlow: "rgba(184,134,11,0.35)",
    textColor: "text-gray-900",
    sidebarBg: "bg-white/80 backdrop-blur-xl",
    mainBg: "bg-gray-50/70 backdrop-blur-lg",
    cardBg: "bg-white/70 backdrop-blur-md",
    cardBorder: "border-gray-200/50",
    cardHover: "hover:bg-gray-100/90",
    selectedCard: "bg-gray-100/80",
    selectedBorder: "border-gray-400/50",
    selectedGlow: "shadow-[0_0_12px_-3px_rgba(0,0,0,0.06)]",
    accent: "text-gray-800",
    accentBg: "bg-gray-500/10",
    accentBorder: "border-gray-400/30",
    accentHover: "hover:bg-gray-500/15",
    mutedText: "text-gray-600/85",
    btnPrimary: { color: "hsl(0 0% 18%)", border: "hsl(0 0% 40% / 0.5)", bg: "hsl(0 0% 40% / 0.08)", hoverBg: "hsl(0 0% 40% / 0.18)", shadow: "hsl(0 0% 40% / 0.2)" },
    btnSecondary: { color: "hsl(0 0% 30%)", border: "hsl(0 0% 50% / 0.4)", bg: "hsl(0 0% 50% / 0.06)", hoverBg: "hsl(0 0% 50% / 0.14)", shadow: "hsl(0 0% 50% / 0.15)" },
    btnOutline: "border-gray-300/70 text-gray-700 hover:bg-gray-100/80",
    inputBorder: "border-gray-200/70",
    inputBg: "bg-white/80",
    inputFocus: "focus:ring-gray-400/40",
    badgeBg: "bg-gray-100/70",
    authCard: "border-gray-200/50 bg-white/80",
    authCardText: "text-gray-900",
    authLabel: "text-gray-600/80",
    authInput: "border-gray-300/70 bg-white/80 text-gray-900 placeholder:text-gray-400 focus:ring-gray-400/50",
    authLink: "text-gray-600 hover:text-gray-800",
    authSubtext: "text-gray-500/80",
    authOverlay: "from-gray-200/20 via-transparent to-gray-100/10",
    switcherActive: "bg-gray-400/25 ring-gray-400/50",
  },
];
  ...
  useEffect(() => {
    ...
    if (isLight) {
      if (themeIndex === 0) {
        ...
        root.style.setProperty("--muted-foreground", "220 35% 28%");
        root.style.setProperty("--accent-foreground", "50 85% 24%");
        root.style.setProperty("--secondary-foreground", "220 55% 22%");
        root.style.setProperty("--background", "270 40% 96%");
        root.style.setProperty("--popover", "0 0% 100%");
        root.style.setProperty("--accent", "50 95% 88%");
