...
export const themes: AppTheme[] = [
  ...
  {
    name: "⚡ 青年勇猛", emoji: "⚡",
    headerBg: "bg-slate-900 backdrop-blur-md",
    headerBorder: "border-blue-500/20",
    titleColor: "#60a5fa",
    titleGlow: "rgba(96,165,250,0.4)",
    textColor: "text-blue-50",
    sidebarBg: "bg-slate-900 backdrop-blur-md",
    mainBg: "bg-slate-900",
    cardBg: "bg-slate-800 backdrop-blur-sm",
  ...
  {
    name: "👑 中年旺盛", emoji: "👑",
    headerBg: "bg-stone-950 backdrop-blur-md",
    headerBorder: "border-amber-600/20",
    titleColor: "#fbbf24",
    titleGlow: "rgba(251,191,36,0.5)",
    textColor: "text-amber-50",
    sidebarBg: "bg-stone-950 backdrop-blur-md",
    mainBg: "bg-stone-900",
    cardBg: "bg-stone-800 backdrop-blur-sm",
  ...
  {
    name: "🌌 老年智慧", emoji: "🌌",
    headerBg: "bg-indigo-950 backdrop-blur-md",
    headerBorder: "border-indigo-400/15",
    titleColor: "#a5b4fc",
    titleGlow: "rgba(165,180,252,0.4)",
    textColor: "text-indigo-50",
    sidebarBg: "bg-indigo-950 backdrop-blur-md",
    mainBg: "bg-indigo-950",
    cardBg: "bg-indigo-900 backdrop-blur-sm",
