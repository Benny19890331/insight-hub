...
export const themes: AppTheme[] = [
  {
    ...
    sidebarBg: "bg-pink-50/50",
    mainBg: "bg-gradient-to-br from-pink-50/30 via-white/20 to-purple-50/30",
  ...
  },
  {
    ...
    mainBg: "bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950/50",
  ...
  },
  {
    ...
    sidebarBg: "bg-stone-950/80",
    mainBg: "bg-gradient-to-br from-stone-950 via-stone-900 to-amber-950/30",
  ...
  },
  {
    ...
    mainBg: "bg-gradient-to-br from-indigo-950 via-slate-900 to-teal-950/30",
